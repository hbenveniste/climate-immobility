...
include("Addimpact_nice_Component.jl")
...
function getmigrationnicemodel(;datamigdir=path_datamigdir,scen="SSP2",migyesno="mig",xi=1.0,omega=1.0)
    ...
    add_comp!(m, addimpact_nice, :addimpact, after=:migration)
    ...
    set_param!(m, :migration, :ageshare, param_mig_3["ageshare_ineq"])
    set_param!(m, :migration, :agegroupinit, param_mig_3["agegroupinit_ineq"])
    ...
    set_param!(m, :migration, :migstockinit, param_mig_3["migstockinit_ineq"])
    set_param!(m, :migration, :gravres_qi, param_mig_3["gravres_qi"])        
    set_param!(m, :migration, :beta0_quint, param_mig[:beta0])        
    set_param!(m, :migration, :beta1_quint, param_mig[:beta1])        
    set_param!(m, :migration, :beta2_quint, param_mig[:beta2])        
    set_param!(m, :migration, :beta4_quint, param_mig[:beta4])        
    set_param!(m, :migration, :beta5_quint, param_mig[:beta5])        
    set_param!(m, :migration, :beta7_quint, param_mig[:beta7])        
    set_param!(m, :migration, :beta8_quint, param_mig[:beta8])        
    set_param!(m, :migration, :beta9_quint, param_mig[:beta9])        
    set_param!(m, :migration, :beta10_quint, param_mig[:beta10])        
    set_param!(m, :migration, :gamma0_quint, param_mig[:gamma0])
    set_param!(m, :migration, :gamma1_quint, param_mig[:gamma1])
