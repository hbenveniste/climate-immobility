...
@defcomp nice_socioeconomic begin
        ...
        if is_first(t)
            ...
            for r in d.regions
                ...
                for q in d.quintiles
                    ...
                    v.quintile_old_income[t, r, q] = v.quintile_income[t-1, r, q] - (t >= TimestepValue(1990) && !p.runwithoutdamage ? p.consleak * p.eloss[t - 1, r] * v.damage_distribution[t-1,r,q] / 10.0 : 0) 
                    v.quintile_income[t, r, q]     = (1 + v.ygrowth[t, r]) * (1 + 0.01 * quintginigrowth) * v.quintile_old_income[t,r,q] - p.mitigationcost[t-1,r] * v.mitigation_distribution[t-1,r,q] 
                ...
                # Linear decline in growth during 2100-2300. Steady state after 2300
